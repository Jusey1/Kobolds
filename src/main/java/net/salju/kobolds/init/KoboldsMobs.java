...
public class KoboldsMobs {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<KoboldChild>> KOBOLD_CHILD = register("kobold_child", EntityType.Builder.of(KoboldChild::new, MobCategory.MISC).sized(0.5F, 1.48F).eyeHeight(1.26F).ridingOffset(-0.45F));
