...
public class KoboldsMobs {
	...
	public static final RegistryObject<EntityType<Kobold>> KOBOLD = register("kobold", EntityType.Builder.<Kobold>of(Kobold::new, MobCategory.MISC).sized(0.5f, 1.48f));
	public static final RegistryObject<EntityType<KoboldWarrior>> KOBOLD_WARRIOR = register("kobold_warrior", EntityType.Builder.<KoboldWarrior>of(KoboldWarrior::new, MobCategory.MISC).sized(0.5f, 1.48f));
	...
	public static final RegistryObject<EntityType<KoboldSkeleton>> KOBOLD_SKELETON = register("kobold_skeleton", EntityType.Builder.<KoboldSkeleton>of(KoboldSkeleton::new, MobCategory.MONSTER).sized(0.5f, 1.48f));
