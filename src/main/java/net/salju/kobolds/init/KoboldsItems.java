...
public class KoboldsItems {
	...
	public static final DeferredHolder<Item, Item> KOBOLD_IRON_PICKAXE = REGISTRY.register("kobold_iron_pickaxe", () -> new PickaxeItem(ToolMaterial.IRON, 1.0F, -2.8F, createBaseProps("kobold_iron_pickaxe")));
	public static final DeferredHolder<Item, Item> KOBOLD_IRON_AXE = REGISTRY.register("kobold_iron_axe", () -> new AxeItem(ToolMaterial.IRON, 5.0F, -3.0F, createBaseProps("kobold_iron_axe")));
	public static final DeferredHolder<Item, Item> KOBOLD_IRON_HOE = REGISTRY.register("kobold_iron_hoe", () -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, createBaseProps("kobold_iron_hoe")));
