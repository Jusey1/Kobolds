...
public class KoboldsItems {
	...
	public static final DeferredHolder<Item, Item> KOBOLD_SPAWN_EGG = REGISTRY.register("kobold_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD.get(), createBaseProps("kobold_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_WARRIOR_SPAWN_EGG = REGISTRY.register("kobold_warrior_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_WARRIOR.get(), createBaseProps("kobold_warrior_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_ENCHANTER_SPAWN_EGG = REGISTRY.register("kobold_enchanter_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_ENCHANTER.get(), createBaseProps("kobold_enchanter_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_RASCAL_SPAWN_EGG = REGISTRY.register("kobold_rascal_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_RASCAL.get(), createBaseProps("kobold_rascal_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_ENGINEER_SPAWN_EGG = REGISTRY.register("kobold_engineer_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_ENGINEER.get(), createBaseProps("kobold_engineer_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_PIRATE_SPAWN_EGG = REGISTRY.register("kobold_pirate_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_PIRATE.get(), createBaseProps("kobold_pirate_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_CAPTAIN_SPAWN_EGG = REGISTRY.register("kobold_captain_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_CAPTAIN.get(), createBaseProps("kobold_captain_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_ZOMBIE_SPAWN_EGG = REGISTRY.register("kobold_zombie_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_ZOMBIE.get(), createBaseProps("kobold_zombie_spawn_egg")));
	public static final DeferredHolder<Item, Item> KOBOLD_SKELETON_SPAWN_EGG = REGISTRY.register("kobold_skeleton_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.KOBOLD_SKELETON.get(), createBaseProps("kobold_skeleton_spawn_egg")));
	public static final DeferredHolder<Item, Item> WITHERBOLD_SPAWN_EGG = REGISTRY.register("witherbold_spawn_egg", () -> new SpawnEggItem(KoboldsMobs.WITHERBOLD.get(), createBaseProps("witherbold_spawn_egg")));
