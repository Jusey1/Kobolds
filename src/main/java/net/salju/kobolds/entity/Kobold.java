...
public class Kobold extends AbstractKoboldEntity {
	public Kobold(PlayMessages.SpawnEntity packet, Level world) {
		this(KoboldsMobs.KOBOLD.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new Kobold.KoboldTradeGoal(this));
		this.goalSelector.addGoal(1, new Kobold.KoboldWarriorGoal(this));
		...
		public void start() {
			...
			KoboldsMod.queueServerWork(600, () -> {
				...
				if (world instanceof ServerLevel lvl) {
					...
					KoboldWarrior war = this.kobold.convertTo(KoboldsMobs.KOBOLD_WARRIOR.get(), true);
