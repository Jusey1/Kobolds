...
public class KoboldEngineer extends AbstractKoboldEntity {
	public KoboldEngineer(PlayMessages.SpawnEntity packet, Level world) {
		this(KoboldsMobs.KOBOLD_ENGINEER.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new KoboldEngineer.KoboldTradeGoal(this));
			...
			KoboldsMod.queueServerWork(100, () -> {
				if (this.kobold.isAlive()) {
					...
					if (world instanceof ServerLevel lvl) {
						List<ItemStack> list = this.kobold.getTradeItems(this.kobold, "kobolds:gameplay/engineer_loot");
