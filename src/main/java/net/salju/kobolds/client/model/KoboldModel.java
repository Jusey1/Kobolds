...
public class KoboldModel<T extends AbstractKoboldState> extends HumanoidModel<T> {
	...
	public static MeshDefinition createMesh(CubeDeformation cube, float f) {
        ...
        head.addOrReplaceChild("baby_left_horn", CubeListBuilder.create().texOffs(36, 8).addBox(-0.5F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -7.0F, 2.0F, -0.6109F, 0.3054F, 0.1745F));
        head.addOrReplaceChild("baby_right_horn", CubeListBuilder.create().texOffs(45, 8).addBox(-1.5F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -7.0F, 2.0F, -0.6109F, -0.3054F, -0.1745F));
