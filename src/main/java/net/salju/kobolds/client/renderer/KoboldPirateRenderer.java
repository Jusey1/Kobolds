...
public class KoboldPirateRenderer extends MobRenderer<KoboldPirate, KoboldModel<KoboldPirate>> {
	public KoboldPirateRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new ItemInHandLayer<KoboldPirate, KoboldModel<KoboldPirate>>(this, context.getItemInHandRenderer()));
		this.addLayer(new EyesLayer<KoboldPirate, KoboldModel<KoboldPirate>>(this) {
			@Override
	...
	@Override
	public ResourceLocation getTextureLocation(KoboldPirate entity) {
		return new ResourceLocation("kobolds:textures/entities/kobold_pirate.png");
	}

	@Override
	public void render(KoboldPirate kobold, float f1, float f2, PoseStack stack, MultiBufferSource buffer, int inty) {
		stack.pushPose();
